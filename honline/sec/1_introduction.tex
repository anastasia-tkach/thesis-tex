...
\section{Introduction} \label{sec:honline-intro}

%% AR/VR
%In our everyday life we interact with the surrounding environment using our hands. A main focus of recent research has been to bring such interaction to virtual objects, such as the ones projected in virtual reality devices, % (Oculus Rift, HTC Vive)
%or super-imposed as holograms in AR/MR headsets\hidden{(Microsoft Hololens, Intel Alloy)}. 
...
\subsection*{Tracking templates and personalization}
% generic calibration
...
% online calibration
Therefore, inspired by recent efforts in facial performance capture that calibrate templates while tracking~\cite{li_sig13,bouaziz2013online}, in this chapter we propose a pipeline for \emph{online} model calibration. 
% \AT{sure, done}
